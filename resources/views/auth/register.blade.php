        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class>
                    ...
                    <x-input id="telefono" class="block mt-1 w-full"  name="telefono" :value="old('telefono')" required  />
                </div>

                <div class>
                    <x-label for="direccion" value="direccion" />
                    <x-input id="direccion" class="block mt-1 w-full"  name="direccion" :value="old('direccion')" required  />
                </div>
